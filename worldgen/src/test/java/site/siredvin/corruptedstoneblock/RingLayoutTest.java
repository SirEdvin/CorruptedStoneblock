...
class RingLayoutTest {
    ...
    private int region(int x, int z) { return RingLayout.region(x, z, 0, 0, WIDTHS); }

    @Test void boundariesAndSymmetry() {
